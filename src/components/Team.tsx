  ...
  const founders = [
    {
      name: 'Marshall Burns',
      role: 'CEO',
      description: 'Oh Captain, my Captain! He\'s the one who wrote these descriptions. He\'s also the one who leads the vision',
      avatar: 'MB',
    ...
    },
    {
      ...
      avatar: 'GR',
      linkedin: 'https://www.linkedin.com/in/gregory-reeves/',
    },
    {
      name: 'Isaac Cobb',
      role: 'CPO',
      ...
      avatar: 'IC',
      linkedin: 'https://www.linkedin.com/in/isaac-cobb/',
    }
  ];
          ...
          {founders.map((founder, index) => (
            <div key={index} className="group bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="flex justify-center space-x-4">
                <button className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 group/btn">
